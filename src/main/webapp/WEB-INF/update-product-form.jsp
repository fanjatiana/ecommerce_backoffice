...
<form method="post" action="${pageContext.request.contextPath}/update-product">
    <div class="input-group mb-3">
        <input type="hidden" class="form-control" name="id" value="${id}" placeholder="id...">
    </div>
    <div class="input-group mb-3">
        <input type="text" class="form-control" name="nameProduct" value="${nameProduct}" placeholder="Name Product...">
    </div>
